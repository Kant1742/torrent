...
!function(e, t) {
    ...
    e.extend = e.fn.extend = function() {
        var r, a, n, o, s, l, t = arguments[0] || {}, i = 1, c = arguments.length, u = !1;
        for ("boolean" == typeof t && (u = t,
        t = arguments[i] || {},
        i++),
        ...
        i--); c > i; i++)
            if (null != (s = arguments[i]))
                for (o in s)
                    r = t[o],
                    n = s[o],
                    t !== n && (u && n && (e.isPlainObject(n) || (a = e.isArray(n))) ? (a ? (a = !1,
                    l = r && e.isArray(r) ? r : []) : l = r && e.isPlainObject(r) ? r : {},
                    t[o] = e.extend(u, l, n)) : void 0 !== n && (t[o] = n));
        return t
    }
    ,
    e.extend({
        ...
        makeArray: function(t, n) {
            var r = n || [];
            return null != t && (ie(Object(t)) ? e.merge(r, "string" == typeof t ? [t] : t) : J.call(r, t)),
            r
        },
        ...
        proxy: function(t, n) {
            var i, r, o;
            return "string" == typeof n && (o = t[n],
            n = t,
            t = o),
            e.isFunction(t) ? (i = m.call(arguments, 2),
            r = function() {
    ...
    ;var N = function(e) {
        var E, i, t, B, le, j, Q, oe, M, b, k, y, s, h, f, l, C, O, D, a = "sizzle" + -new Date, c = e.document, p = 0, xe = 0, se = U(), K = U(), Z = U(), J = function(e, t) {
            return e === t && (k = !0),
            0
        }, S = "undefined", ae = 1 << 31, Ee = {}.hasOwnProperty, v = [], de = v.pop, ce = v.push, x = v.push, ie = v.slice, w = v.indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , G = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", n = "[\\x20\\t\\r\\n\\f]", N = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ne = N.replace("w", "w#"), re = "\\[" + n + "*(" + N + ")(?:" + n + "*([*^$|!~]?=)" + n + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ne + "))|)" + n + "*\\]", Y = ":(" + N + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + re + ")*)|.*)\\)|)", F = new RegExp("^" + n + "+|((?:^|[^\\\\])(?:\\\\.)*)" + n + "+$","g"), ve = new RegExp("^" + n + "*," + n + "*"), ye = new RegExp("^" + n + "*([>+~]|" + n + ")" + n + "*"), Ne = new RegExp("=" + n + "*([^\\]'\"]*?)" + n + "*\\]","g"), pe = new RegExp(Y), ge = new RegExp("^" + ne + "$"), L = {
            ID: new RegExp("^#(" + N + ")"),
            CLASS: new RegExp("^\\.(" + N + ")"),
        ...
        }, Ce = /^(?:input|select|textarea|button)$/i, Te = /^h\d$/i, A = /^[^{]+\{\s*\[native \w/, we = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, P = /[+~]/, be = /'|\\/g, g = new RegExp("\\\\([\\da-f]{1,6}" + n + "?|(" + n + ")|.)","ig"), m = function(e, t, n) {
            var r = "0x" + t - 65536;
            return r !== r || n ? t : 0 > r ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
        };
        try {
            x.apply(v = ie.call(c.childNodes), c.childNodes),
            v[c.childNodes.length].nodeType
        } catch (o) {
            x = {
        ...
        ;function r(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : c) !== s && y(t),
            t = t || s,
            n = n || [],
            !e || "string" != typeof e)
                return n;
            if (1 !== (h = t.nodeType) && 9 !== h)
                return [];
            if (f && !r) {
                if (g = we.exec(e))
                    if (d = g[1]) {
                        if (9 === h) {
                            ...
                            if (u.id === d)
                                return n.push(u),
                                n
                        } else if (t.ownerDocument && (u = t.ownerDocument.getElementById(d)) && D(t, u) && u.id === d)
                            return n.push(u),
                            n
                    } else {
                        if (g[2])
                            ...
                            n;
                        if ((d = g[3]) && i.getElementsByClassName && t.getElementsByClassName)
                            return x.apply(n, t.getElementsByClassName(d)),
                            n
                    }
                ;if (i.qsa && (!l || !l.test(e))) {
                    if (p = b = a,
                    ...
                    1 === h && "object" !== t.nodeName.toLowerCase()) {
                        m = j(e),
                        (b = t.getAttribute("id")) ? p = b.replace(be, "\\$&") : t.setAttribute("id", p),
                        p = "[id='" + p + "'] ",
                        v = m.length;
                        while (v--)
                            m[v] = p + q(m[v]);
                    ...
                    ;if (w)
                        try {
                            return x.apply(n, T.querySelectorAll(w)),
                            n
                        } catch (o) {} finally {
        ...
        ;function U() {
            var n = [];
            function e(r, i) {
                return n.push(r + " ") > t.cacheLength && delete e[n.shift()],
                e[r + " "] = i
            }
            ;return e
        }
        ...
        ;i = r.support = {},
        le = r.isXML = function(e) {
            var t = e && (e.ownerDocument || e).documentElement;
            return t ? "HTML" !== t.nodeName : !1
        }
        ,
        y = r.setDocument = function(e) {
            var d, r = e ? e.ownerDocument || e : c, o = r.defaultView;
            ...
            C = [],
            l = [],
            (i.qsa = A.test(r.querySelectorAll)) && (u(function(e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>",
                e.querySelectorAll("[msallowclip^='']").length && l.push("[*^$]=" + n + "*(?:''|\"\")"),
                e.querySelectorAll("[selected]").length || l.push("\\[" + n + "*(?:value|" + G + ")"),
            ...
            (i.matchesSelector = A.test(O = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector)) && u(function(e) {
                i.disconnectedMatch = O.call(e, "div"),
                O.call(e, "[s!='']:x"),
                C.push("!=", Y)
            }),
            l = l.length && new RegExp(l.join("|")),
            C = C.length && new RegExp(C.join("|")),
            d = A.test(h.compareDocumentPosition),
            D = d || A.test(h.contains) ? function(e, t) {
            ...
            J = d ? function(e, t) {
                ...
                1 & n || !i.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === c && D(c, e) ? -1 : t === r || t.ownerDocument === c && D(c, t) ? 1 : b ? w.call(b, e) - w.call(b, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return k = !0,
                    0;
                var n, i = 0, s = e.parentNode, l = t.parentNode, o = [e], a = [t];
                if (!s || !l)
                    return e === r ? -1 : t === r ? 1 : s ? -1 : l ? 1 : b ? w.call(b, e) - w.call(b, t) : 0;
                if (s === l)
                    return ee(e, t);
                n = e;
        ...
        r.matchesSelector = function(e, t) {
            if ((e.ownerDocument || e) !== s && y(e),
            t = t.replace(Ne, "='$1']"),
            !(!i.matchesSelector || !f || C && C.test(t) || l && l.test(t)))
                try {
                    var o = O.call(e, t);
        ...
        r.contains = function(e, t) {
            return (e.ownerDocument || e) !== s && y(e),
            D(e, t)
        }
        ,
        r.attr = function(e, n) {
        ...
        t = r.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var n, t = !e[6] && e[2];
                    return L.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : t && pe.test(t) && (n = j(t, !0)) && (n = t.indexOf(")", t.length - n) - t.length) && (e[0] = e[0].slice(0, n),
                    e[2] = t.slice(0, n)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        var f, y, c, d, h, g, v = l !== s ? "nextSibling" : "previousSibling", m = t.parentNode, b = o && t.nodeName.toLowerCase(), x = !u && !o;
                        if (m) {
                            if (l) {
                                while (v) {
                                    c = t;
                                    while (c = c[v])
                                        if (o ? c.nodeName.toLowerCase() === b : 1 === c.nodeType)
                                            return !1;
                                    g = v = "only" === e && !g && "nextSibling"
                                }
                                ;return !0
                            }
                            ;if (g = [s ? m.firstChild : m.lastChild],
                            s && x) {
                                y = m[a] || (m[a] = {}),
                                f = y[e] || [],
                                h = f[0] === p && f[1],
                            ...
                            } else if (x && (f = (t[a] || (t[a] = {}))[e]) && f[0] === p)
                                d = f[1];
                            else
                                while (c = ++h && c && c[v] || (d = h = 0) || g.pop())
                                    if ((o ? c.nodeName.toLowerCase() === b : 1 === c.nodeType) && ++d && (x && ((c[a] || (c[a] = {}))[e] = [p, d]),
                                    c === t))
                                        break;
                            return d -= i,
                            d === r || d % r === 0 && d / r >= 0
            ...
            pseudos: {
                ...
                lang: d(function(e) {
                    return ge.test(e || "") || r.error("unsupported lang: " + e),
        ...
        for (E in {
            ...
            t.pseudos[E] = he(E);
        function te() {}
        ;te.prototype = t.filters = t.pseudos,
        t.setFilters = new te,
        j = r.tokenize = function(e, n) {
            ...
            c = t.preFilter;
            while (i) {
                (!a || (o = ve.exec(i))) && (o && (i = i.slice(o[0].length) || i),
                u.push(l = [])),
                a = !1,
                (o = ye.exec(i)) && (a = o.shift(),
                l.push({
                    value: a,
                    type: o[0].replace(F, " ")
                }),
                i = i.slice(a.length));
                for (s in t.filter)
                    !(o = L[s].exec(i)) || c[s] && !(o = c[s](o)) || (a = o.shift(),
                    l.push({
                        value: a,
                        type: s,
                        matches: o
        ...
        ;function W(e, t, n, r, i, o) {
            ...
            i && !i[a] && (i = W(i, o)),
            d(function(o, a, s, l) {
                var d, c, f, m = [], h = [], g = a.length, v = o || ue(t || "*", s.nodeType ? [s] : s, []), p = !e || !o && t ? v : H(v, m, e, s, l), u = n ? i || (o ? e : g || r) ? [] : a : p;
                if (n && n(p, u, s, l),
                r) {
                    d = H(u, h),
                    r(d, [], s, l),
                ...
                ;if (o) {
                    if (i || e) {
                        ...
                        ;c = u.length;
                        while (c--)
                            (f = u[c]) && (d = i ? w.call(o, f) : m[c]) > -1 && (o[d] = !(a[d] = f))
                    }
                } else
                    u = H(u === a ? u.splice(g, u.length) : u),
                    i ? i(null, a, u, l) : x.apply(a, u)
            })
        }
        ;function R(e) {
            for (var l, i, r, s = e.length, u = t.relative[e[0].type], c = u || t.relative[" "], n = u ? 1 : 0, d = I(function(e) {
                ...
                if (i = t.relative[e[n].type])
                    o = [I(z(o), i)];
                else {
                    if (i = t.filter[e[n].type].apply(null, e[n].matches),
                    i[a]) {
                        for (r = ++n; s > r; r++)
                            if (t.relative[e[r].type])
                                break;
        ...
        ;function fe(e, n) {
            var i = n.length > 0
              ...
              , a = function(a, l, u, c, d) {
                var h, y, g, v = 0, f = "0", b = a && [], m = [], w = M, T = a || o && t.find.TAG("*", d), C = p += null == w ? 1 : Math.random() || .1, N = T.length;
                ...
                i && f !== v) {
                    ...
                    if (a) {
                        if (v > 0)
                            while (f--)
                                b[f] || m[f] || (m[f] = de.call(c));
                        m = H(m)
                    }
                    ;x.apply(c, m),
                    d && !a && m.length > 0 && v + n.length > 1 && r.uniqueSort(c)
                }
                ;return d && (p = C,
                M = w),
                b
        ...
        oe = r.select = function(e, n, r, o) {
            var l, a, s, d, p, c = "function" == typeof e && e, u = !o && j(e = c.selector || e);
            if (r = r || [],
            1 === u.length) {
                if (a = u[0] = u[0].slice(0),
                a.length > 2 && "ID" === (s = a[0]).type && i.getById && 9 === n.nodeType && f && t.relative[a[1].type]) {
                    if (n = (t.find.ID(s.matches[0].replace(g, m), n) || [])[0],
                    !n)
                        return r;
                    c && (n = n.parentNode),
            ...
            ;return (c || Q(e, u))(o, n, !f, r, P.test(e) && X(n.parentNode) || n),
            r
        }
        ,
        i.sortStable = a.split("").sort(J).join("") === a,
        ...
        find: function(t) {
            ...
            if ("string" != typeof t)
                return this.pushStack(e(t).filter(function() {
                    for (n = 0; o > n; n++)
                        if (e.contains(i[n], this))
                            return !0
                }));
            for (n = 0; o > n; n++)
                e.find(t, i[n], r);
            return r = this.pushStack(o > 1 ? e.unique(r) : r),
    ...
    var j, i = t.document, sn = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, an = e.fn.init = function(t, n) {
        var r, o;
        if (!t)
            return this;
        if ("string" == typeof t) {
            if (r = "<" === t.charAt(0) && ">" === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : sn.exec(t),
            !r || !r[1] && n)
                return !n || n.jquery ? (n || j).find(t) : this.constructor(n).find(t);
            if (r[1]) {
                if (n = n instanceof e ? n[0] : n,
                e.merge(this, e.parseHTML(r[1], n && n.nodeType ? n.ownerDocument || n : i, !0)),
                be.test(r[1]) && e.isPlainObject(n))
                    for (r in n)
                        e.isFunction(this[r]) ? this[r](n[r]) : this.attr(r, n[r]);
                return this
            }
            ;if (o = i.getElementById(r[2]),
            o && o.parentNode) {
                if (o.id !== r[2])
                    return j.find(t);
                this.length = 1,
    ...
    e.extend({
        dir: function(t, n, r) {
            var o = []
              , i = t[n];
            while (i && 9 !== i.nodeType && (void 0 === r || 1 !== i.nodeType || !e(i).is(r)))
    ...
    ;e.Callbacks = function(t) {
        ...
        var s, i, u, o, a, c, n = [], r = !t.once && [], d = function(e) {
            for (i = t.memory && e,
            u = !0,
            a = c || 0,
            c = 0,
            ...
            ;s = !1,
            n && (r ? r.length && d(r.shift()) : i ? n = [] : l.disable())
        }, l = {
            add: function() {
                if (n) {
                    var r = n.length;
    ...
    e.extend({
        Deferred: function(t) {
            ...
            e.each(i, function(e, t) {
                ...
                n[t[0]] = function() {
                    return n[t[0] + "With"](this === n ? r : this, arguments),
                    this
                }
                ,
        ...
        when: function(t) {
            var n = 0, i = m.call(arguments), r = i.length, a = 1 !== r || t && e.isFunction(t.promise) ? r : 0, o = 1 === a ? t : e.Deferred(), u = function(e, t, n) {
                return function(r) {
                    t[e] = this,
                    n[e] = arguments.length > 1 ? m.call(arguments) : r,
                    n === s ? o.notifyWith(t, n) : --a || o.resolveWith(t, n)
                }
            }, s, c, l;
            if (r > 1)
                for (s = new Array(r),
                c = new Array(r),
                l = new Array(r); r > n; n++)
                    i[n] && e.isFunction(i[n].promise) ? i[n].promise().done(u(n, l, i)).fail(o.reject).progress(u(n, c, s)) : --a;
            return a || o.resolveWith(l, i),
            o.promise()
        }
    });
    var H;
    ...
    e.extend({
        ...
        ready: function(t) {
            if (t === !0 ? !--e.readyWait : !e.isReady) {
                ...
                e.isReady = !0,
                t !== !0 && --e.readyWait > 0 || (H.resolveWith(i, [e]),
                e.fn.triggerHandler && (e(i).triggerHandler("ready"),
                e(i).off("ready")))
            }
        }
    });
    function ct() {
        i.addEventListener ? (i.removeEventListener("DOMContentLoaded", h, !1),
        t.removeEventListener("load", h, !1)) : (i.detachEvent("onreadystatechange", h),
        t.detachEvent("onload", h))
    }
    ;function h() {
        (i.addEventListener || "load" === event.type || "complete" === i.readyState) && (ct(),
        e.ready())
    }
    ;e.ready.promise = function(n) {
        if (!H)
            ...
            "complete" === i.readyState)
                ...
                i.addEventListener("DOMContentLoaded", h, !1),
                t.addEventListener("load", h, !1);
            else {
    ...
    e(function() {
        var o, t, e, n;
        e = i.getElementsByTagName("body")[0],
        e && e.style && (t = i.createElement("div"),
        ...
        r.inlineBlockNeedsLayout = o = 3 === t.offsetWidth,
        o && (e.style.zoom = 1)),
        e.removeChild(n))
    }),
    function() {
    ...
    ;function Le(t, n, r, i) {
        if (e.acceptData(t)) {
            ...
            if (o && s[o] && (i || s[o].data) || void 0 !== r || "string" != typeof n)
                return o || (o = c ? t[u] = p.pop() || e.guid++ : u),
                s[o] || (s[o] = c ? {} : {
                    toJSON: e.noop
                }),
                ("object" == typeof n || "function" == typeof n) && (i ? s[o] = e.extend(s[o], n) : s[o].data = e.extend(s[o].data, n)),
                a = s[o],
                i || (a.data || (a.data = {}),
                a = a.data),
                void 0 !== r && (a[e.camelCase(n)] = r),
        ...
        if (e.acceptData(t)) {
            ...
            if (o[a]) {
                if (n && (s = i ? o[a] : o[a].data)) {
                    ...
                    while (l--)
                        delete s[n[l]];
                    if (i ? !le(s) : !e.isEmptyObject(s))
                        return
                }
                (i || (delete o[a].data,
                le(o[a]))) && (u ? e.cleanData([t], !0) : r.deleteExpando || o != o.window ? delete o[a] : o[a] = null)
            }
        }
    }
    ;e.extend({
    ...
    e.fn.extend({
        data: function(t, n) {
            var o, i, a, r = this[0], s = r && r.attributes;
            if (void 0 === t) {
                if (this.length && (a = e.data(r),
                1 === r.nodeType && !e.e$(r, "parsedAttrs"))) {
                    o = s.length;
                    while (o--)
                        s[o] && (i = s[o].name,
                        0 === i.indexOf("data-") && (i = e.camelCase(i.slice(5)),
                        tt(r, i, a[i])));
                    e.e$(r, "parsedAttrs", !0)
                }
                ;return a
    ...
    e.extend({
        queue: function(t, n, r) {
            ...
            i = e.e$(t, n),
            r && (!i || e.isArray(r) ? i = e.e$(t, n, e.makeArray(r)) : i.push(r)),
            i || []) : void 0
        },
    ...
    e.fn.extend({
        ...
        promise: function(t, n) {
            var r, o = 1, a = e.Deferred(), i = this, s = this.length, l = function() {
                --o || a.resolveWith(i, [i])
            };
            "string" != typeof t && (n = t,
            t = void 0),
    ...
    var W = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      ...
      , y = e.access = function(t, n, r, i, o, s, l) {
        ...
        n))
            for (; c > a; a++)
                n(t[a], r, l ? i : i.call(t[a], a, n(t[a], r)));
    ...
    !function() {
        ...
        r.leadingWhitespace = 3 === t.firstChild.nodeType,
        r.tbody = !t.getElementsByTagName("tbody").length,
        r.htmlSerialize = !!t.getElementsByTagName("link").length,
        r.html5Clone = "<:nav></:nav>" !== i.createElement("nav").cloneNode(!0).outerHTML,
        n.type = "checkbox",
        n.checked = !0,
        o.appendChild(n),
    ...
    function() {
        ...
        for (e in {
            ...
            n = "on" + e,
            (r[e + "Bubbles"] = n in t) || (o.setAttribute(n, "t"),
            r[e + "Bubbles"] = o.attributes[n].expando === !1);
        o = null
    }();
    ...
    ;e.event = {
        ...
        add: function(t, n, r, i, o) {
            ...
            if (p) {
                ...
                while (g--)
                    ...
                    (d = h[a]) || (d = h[a] = [],
                    d.delegateCount = 0,
                    s.setup && s.setup.call(t, i, y, l) !== !1 || (t.addEventListener ? t.addEventListener(a, l, !1) : t.attachEvent && t.attachEvent("on" + a, l))),
        ...
        remove: function(t, n, r, i, o) {
            ...
            if (f && (p = f.events)) {
                ...
                while (h--)
                    ...
                    a) {
                        l = e.event.special[a] || {},
                        a = (i ? l.delegateType : l.bindType) || a,
                        d = p[a] || [],
                        u = u[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        y = m = d.length;
                        while (m--)
                            s = d[m],
                            !o && v !== s.origType || r && r.guid !== s.guid || u && !u.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(m, 1),
                            s.selector && d.delegateCount--,
                            l.remove && l.remove.call(t, s));
                        y && !d.length && (l.teardown && l.teardown.call(t, g, f.handle) !== !1 || e.removeEvent(t, a, f.handle),
                        delete p[a])
                    } else
                        for (a in p)
                            e.event.remove(t, a + n[h], r, i, !0);
                e.isEmptyObject(p) && (delete f.handle,
                e.n$(t, "events"))
            }
        },
        trigger: function(n, r, o, a) {
            var f, p, l, g, d, c, v, m = [o || i], u = T.call(n, "type") ? n.type : n, h = T.call(n, "namespace") ? n.namespace.split(".") : [];
            if (l = c = o = o || i,
            3 !== o.nodeType && 8 !== o.nodeType && !nt.test(u + e.event.triggered) && (u.indexOf(".") >= 0 && (h = u.split("."),
            u = h.shift(),
            h.sort()),
            p = u.indexOf(":") < 0 && "on" + u,
            n = n[e.expando] ? n : new e.Event(u,"object" == typeof n && n),
            n.isTrigger = a ? 2 : 3,
            n.namespace = h.join("."),
            n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
            n.result = void 0,
            n.target || (n.target = o),
            r = null == r ? [n] : e.makeArray(r, [n]),
            d = e.event.special[u] || {},
            a || !d.trigger || d.trigger.apply(o, r) !== !1)) {
                if (!a && !d.noBubble && !e.isWindow(o)) {
                    for (g = d.delegateType || u,
                    nt.test(g + u) || (l = l.parentNode); l; l = l.parentNode)
                        m.push(l),
                        c = l;
                    c === (o.ownerDocument || i) && m.push(c.defaultView || c.parentWindow || t)
                }
                ;v = 0;
                while ((l = m[v++]) && !n.isPropagationStopped())
                    n.type = v > 1 ? g : d.bindType || u,
                    f = (e.e$(l, "events") || {})[n.type] && e.e$(l, "handle"),
                    f && f.apply(l, r),
                    f = p && l[p],
                    f && f.apply && e.acceptData(l) && (n.result = f.apply(l, r),
                    n.result === !1 && n.preventDefault());
                if (n.type = u,
                !a && !n.isDefaultPrevented() && (!d.t$ || d.t$.apply(m.pop(), r) === !1) && e.acceptData(o) && p && o[u] && !e.isWindow(o)) {
                    c = o[p],
                    c && (o[p] = null),
                    e.event.triggered = u;
                    try {
        ...
        dispatch: function(t) {
            t = e.event.fix(t);
            var a, o, n, r, s, l = [], u = m.call(arguments), c = (e.e$(this, "events") || {})[t.type] || [], i = e.event.special[t.type] || {};
            if (u[0] = t,
            ...
            !i.preDispatch || i.preDispatch.call(this, t) !== !1) {
                ...
                while ((r = l[a++]) && !t.isPropagationStopped()) {
                    ...
                    s = 0;
                    while ((n = r.handlers[s++]) && !t.isImmediatePropagationStopped())
                        (!t.namespace_re || t.namespace_re.test(n.namespace)) && (t.handleObj = n,
                        t.data = n.data,
                        o = ((e.event.special[n.origType] || {}).handle || n.handler).apply(r.elem, u),
        ...
        handlers: function(t, n) {
            var o, a, i, s, u = [], l = n.delegateCount, r = t.target;
                ...
                for (; r != this; r = r.parentNode || this)
                    if (1 === r.nodeType && (r.disabled !== !0 || "click" !== t.type)) {
                        ...
                        s = 0; l > s; s++)
                            a = n[s],
                            o = a.selector + " ",
                            void 0 === i[o] && (i[o] = a.needsContext ? e(o, this).index(r) >= 0 : e.find(o, this, null, [r]).length),
                            i[o] && i.push(a);
                        i.length && u.push({
                            elem: r,
                            handlers: i
        ...
        fix: function(t) {
            if (t[e.expando])
                return t;
            var a, s, l, r = t.type, o = t, n = this.fixHooks[r];
            n || (this.fixHooks[r] = n = Xt.test(r) ? this.mouseHooks : qt.test(r) ? this.keyHooks : {}),
            ...
            while (a--)
                s = l[a],
                t[s] = o[s];
            return t.target || (t.target = o.srcElement || i),
        ...
        mouseHooks: {
            ...
            filter: function(e, t) {
                var n, a, r, o = t.button, s = t.fromElement;
                return null == e.pageX && null != t.clientX && (a = e.target.ownerDocument || i,
                r = a.documentElement,
                n = a.body,
        ...
        simulate: function(t, n, r, i) {
            ...
            i ? e.event.trigger(o, null, n) : e.event.dispatch.call(n, o),
    ...
    : function(e, t, n) {
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === u && (e[r] = null),
        e.detachEvent(r, n))
    }
    ,
    e.Event = function(t, n) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? O : k) : this.type = t,
        n && e.extend(this, n),
        ...
        e.event.special[n] = {
            setup: function() {
                var i = this.ownerDocument || this
                  , o = e.e$(i, n);
                o || i.addEventListener(t, r, !0),
                e.e$(i, n, (o || 0) + 1)
            },
            teardown: function() {
                var i = this.ownerDocument || this
                  , o = e.e$(i, n) - 1;
                o ? e.e$(i, n, o) : (i.removeEventListener(t, r, !0),
                e.n$(i, n))
            }
        }
    }),
    ...
    function a(t, n) {
        ...
        if (!r)
            for (r = [],
            o = t.childNodes || t; null != (i = o[s]); s++)
                !n || e.nodeName(i, n) ? r.push(i) : e.merge(r, a(i, n));
    ...
    ;function Z(t, n) {
        for (var i, r = 0; null != (i = t[r]); r++)
            e.e$(i, "globalEval", !n || e.e$(n[r], "globalEval"))
    }
    ;function ye(t, n) {
        if (1 === n.nodeType && e.hasData(t)) {
            var i, o, s, l = e.e$(t), r = e.e$(n, l), a = l.events;
            if (a) {
                delete r.handle,
                r.events = {};
                for (i in a)
    ...
    ;function ht(t, n) {
        ...
        if (1 === n.nodeType) {
            ...
            !r.noCloneEvent && n[e.expando]) {
                o = e.e$(n);
                for (a in o.events)
                    e.removeEvent(n, a, o.handle);
                n.removeAttribute(e.expando)
            }
            ;"script" === i && n.text !== t.text ? (qe(n).text = t.text,
            we(n)) : "object" === i ? (n.parentNode && (n.outerHTML = t.outerHTML),
            r.html5Clone && t.innerHTML && !e.trim(n.innerHTML) && (n.innerHTML = t.innerHTML)) : "input" === i && se.test(t.type) ? (n.defaultChecked = n.checked = t.checked,
            n.value !== t.value && (n.value = t.value)) : "option" === i ? n.defaultSelected = n.selected = t.defaultSelected : ("input" === i || "textarea" === i) && (n.defaultValue = t.defaultValue)
        }
    }
    ;e.extend({
        clone: function(t, n, i) {
            var o, c, l, s, u, d = e.contains(t.ownerDocument, t);
            if (r.html5Clone || e.isXMLDoc(t) || !Ge.test("<" + t.nodeName + ">") ? l = t.cloneNode(!0) : (K.innerHTML = t.outerHTML,
            K.removeChild(l = K.firstChild)),
            !(r.noCloneEvent && r.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || e.isXMLDoc(t)))
                for (o = a(l),
                u = a(t),
                s = 0; null != (c = u[s]); ++s)
                    o[s] && ht(c, o[s]);
        ...
        buildFragment: function(t, n, i, o) {
            for (var c, s, v, u, m, g, f, y = t.length, p = ke(n), d = [], h = 0; y > h; h++)
                ...
                s || 0 === s)
                    if ("object" === e.type(s))
                        ...
                        m = (Ze.exec(s) || ["", ""])[1].toLowerCase(),
                        f = l[m] || l.t$,
                        u.innerHTML = f[1] + s.replace(Fe, "<$1></$2>") + f[2],
                        c = f[0];
                        while (c--)
                            u = u.lastChild;
                        if (!r.leadingWhitespace && U.test(s) && d.push(n.createTextNode(U.exec(s)[0])),
                        !r.tbody) {
                            s = "table" !== m || et.test(s) ? "<table>" !== f[1] || et.test(s) ? 0 : u : u.firstChild,
            ...
            u && p.removeChild(u),
            r.appendChecked || e.grep(a(d, "input"), dt),
            h = 0;
            while (s = d[h++])
        ...
        cleanData: function(t, n) {
            for (var i, a, o, s, d = 0, l = e.expando, c = e.cache, f = r.deleteExpando, h = e.event.special; null != (i = t[d]); d++)
                if ((n || e.acceptData(i)) && (o = i[l],
                s = o && c[o])) {
                    if (s.events)
                        for (a in s.events)
                            h[a] ? e.event.remove(i, a) : e.removeEvent(i, a, s.handle);
                    c[o] && (delete c[o],
                    f ? delete i[l] : typeof i.removeAttribute !== u ? i.removeAttribute(l) : i[l] = null,
                    p.push(o))
                }
        }
    }),
    e.fn.extend({
        ...
        remove: function(t, n) {
            for (var r, o = t ? e.filter(t, this) : this, i = 0; null != (r = o[i]); i++)
                n || 1 !== r.nodeType || e.cleanData(a(r)),
                r.parentNode && (n && e.contains(r.ownerDocument, r) && Z(a(r, "script")),
        ...
        domManip: function(t, n) {
            t = Ce.apply([], t);
            var u, i, c, s, p, l, o = 0, d = this.length, m = this, g = d - 1, f = t[0], h = e.isFunction(f);
            if (h || d > 1 && "string" == typeof f && !r.checkClone && St.test(f))
                return this.each(function(e) {
                    var r = m.eq(e);
                    h && (t[0] = f.call(this, e, r.html())),
                    r.domManip(t, n)
                });
            if (d && (l = e.buildFragment(t, this[0].ownerDocument, !1, this),
            u = l.firstChild,
            1 === l.childNodes.length && (l = u),
            u)) {
                for (s = e.map(a(l, "script"), qe),
                c = s.length; d > o; o++)
                    i = l,
                    o !== g && (i = e.clone(i, !0, !0),
                    c && e.merge(s, a(i, "script"))),
                    n.call(this[o], i, o);
                if (c)
                    ...
                    o = 0; c > o; o++)
                        i = s[o],
                        st.test(i.type || "") && !e.e$(i, "globalEval") && e.contains(p, i) && (i.src ? e.a$ && e.a$(i.src) : e.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Et, "")));
                l = u = null
            }
            ;return this
        }
    ...
    e.each({
        ...
        e.fn[t] = function(t) {
            for (var i, r = 0, o = [], a = e(t), s = a.length - 1; s >= r; r++)
    ...
    var A, Je = {};
    function me(n, r) {
        var o, i = e(r.createElement(n)).appendTo(r.body), a = t.getDefaultComputedStyle && (o = t.getDefaultComputedStyle(i[0])) ? o.display : e.css(i[0], "display");
        return i.detach(),
        a
    }
    ;function F(t) {
        var r = i
          , n = Je[t];
        return n || (n = me(t, r),
        "none" !== n && n || (A = (A || e("<iframe frameborder='0' width='0' height='0'/>")).appendTo(r.documentElement),
        r = (A[0].contentWindow || A[0].contentDocument).document,
        r.write(),
        r.close(),
        n = me(t, r),
        A.detach()),
    ...
    ;!function() {
        ...
        r.shrinkWrapBlocks = function() {
            ...
            typeof t.style.zoom !== u && (t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
    ...
    var Xe = /^margin/, M = new RegExp("^(" + W + ")(?!px)[a-z%]+$","i"), g, v, Nt = /^(top|right|bottom|left)$/;
    ...
    v = function(t, n, r) {
        ...
        return r = r || g(t),
        i = r ? r.getPropertyValue(n) || r[n] : void 0,
        r && ("" !== i || e.contains(t.ownerDocument, t) || (i = e.style(t, n)),
        M.test(i) && Xe.test(n) && (a = o.width,
        s = o.minWidth,
        l = o.maxWidth,
    ...
    v = function(e, t, n) {
        ...
        r = n ? n[t] : void 0,
        null == r && i && i[t] && (r = i[t]),
        M.test(r) && !Nt.test(t) && (s = i.left,
        o = e.runtimeStyle,
        a = o && o.left,
        a && (o.left = e.currentStyle.left),
        i.left = "fontSize" === t ? "1em" : r,
        r = i.pixelLeft + "px",
        i.left = s,
        a && (o.left = a)),
        void 0 === r ? r : r + "" || "auto"
    ...
    ;!function() {
        var o, n, d, s, l, a, u;
        if (o = i.createElement("div"),
        o.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",
        d = o.getElementsByTagName("a")[0],
        n = d && d.style) {
            n.cssText = "float:left;opacity:.5",
            r.opacity = "0.5" === n.opacity,
            r.cssFloat = !!n.cssFloat,
            o.style.backgroundClip = "content-box",
            o.cloneNode(!0).style.backgroundClip = "",
            r.clearCloneStyle = "content-box" === o.style.backgroundClip,
            r.boxSizing = "" === n.boxSizing || "" === n.MozBoxSizing || "" === n.WebkitBoxSizing,
            e.extend(r, {
            ...
            function c() {
                ...
                e = n.appendChild(i.createElement("div")),
                ...
                n.style.width = "1px",
                u = !parseFloat((t.getComputedStyle(e, null) || {}).marginRight)),
    ...
    ;function rt(t, n) {
        for (var o, r, s, a = [], i = 0, l = t.length; l > i; i++)
            r = t[i],
            r.style && (a[i] = e.e$(r, "olddisplay"),
            o = r.style.display,
            n ? (a[i] || "none" !== o || (r.style.display = ""),
            "" === r.style.display && D(r) && (a[i] = e.e$(r, "olddisplay", F(r.nodeName)))) : (s = D(r),
            (o && "none" !== o || !s) && e.e$(r, "olddisplay", s ? o : e.css(r, "display"))));
        for (i = 0; l > i; i++)
            r = t[i],
            r.style && (n && "none" !== r.style.display && "" !== r.style.display || (r.style.display = n ? a[i] || "" : "none"));
        return t
    }
    ;function it(e, t, n) {
        var r = Bt.exec(t);
    ...
    ;function ot(t, n, r, i, o) {
        for (var a = r === (i ? "border" : "content") ? 4 : "width" === n ? 1 : 0, s = 0; 4 > a; a += 2)
            "margin" === r && (s += e.css(t, r + w[a], !0, o)),
            i ? ("content" === r && (s -= e.css(t, "padding" + w[a], !0, o)),
            "margin" !== r && (s -= e.css(t, "border" + w[a] + "Width", !0, o))) : (s += e.css(t, "padding" + w[a], !0, o),
            "padding" !== r && (s += e.css(t, "border" + w[a] + "Width", !0, o)));
        return s
    }
    ;function at(t, n, i) {
        var s = !0
        ...
        if (0 >= o || null == o) {
            ...
            M.test(o))
                return o;
            s = l && (r.boxSizingReliable() || o === t.style[n]),
            o = parseFloat(o) || 0
        }
    ...
    ;e.extend({
        ...
        style: function(t, n, i, o) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var l, c, s, u = e.camelCase(n), d = t.style;
                if (n = e.cssProps[u] || (e.cssProps[u] = fe(d, u)),
                s = e.cssHooks[n] || e.cssHooks[u],
                void 0 === i)
                    return s && "get"in s && void 0 !== (l = s.get(t, !1, o)) ? l : d[n];
                if (c = typeof i,
                "string" === c && (l = Ft.exec(i)) && (i = (l[1] + 1) * l[2] + parseFloat(e.css(t, n)),
                c = "number"),
                null != i && i === i && ("number" !== c || e.cssNumber[u] || (i += "px"),
                r.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (d[n] = "inherit"),
                !(s && "set"in s && void 0 === (i = s.set(t, i, o)))))
                    try {
                        d[n] = i
                    } catch (a) {}
            }
        ...
        css: function(t, n, r, i) {
            ...
            return n = e.cssProps[s] || (e.cssProps[s] = fe(t.style, s)),
            a = e.cssHooks[n] || e.cssHooks[s],
            a && "get"in a && (o = a.get(t, !0, r)),
            void 0 === o && (o = v(t, n, i)),
            "normal" === o && n in ze && (o = ze[n]),
            "" === r || r ? (l = parseFloat(o),
            r === !0 || e.isNumeric(l) ? l || 0 : o) : o
        }
    }),
    ...
    r.opacity || (e.cssHooks.opacity = {
        ...
        set: function(t, n) {
            ...
            r.zoom = 1,
            (n >= 1 || "" === n) && "" === e.trim(o.replace(re, "")) && r.removeAttribute && (r.removeAttribute("filter"),
            "" === n || i && !i.filter) || (r.filter = re.test(o) ? o.replace(re, a) : o + " " + a)
        }
    }),
    ...
    e.each({
        ...
        e.cssHooks[t + n] = {
            expand: function(e) {
                for (var r = 0, o = {}, i = "string" == typeof e ? e.split(" ") : [e]; 4 > r; r++)
                    o[t + w[r] + n] = i[r] || i[r - 2] || i[0];
                return o
            }
        },
    ...
    s.prototype = {
        ...
        run: function(t) {
            ...
            return this.pos = r = this.options.duration ? e.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t,
            this.now = (this.end - this.start) * r + this.start,
            this.options.step && this.options.step.call(this.elem, this.now, this),
            n && n.set ? n.set(this) : s.propHooks.t$.set(this),
            this
        }
    },
    ...
    e.fx.step = {};
    var E, R, zt = /^(?:toggle|show|hide)$/, Pe = new RegExp("^(?:([+-])=|)(" + W + ")([a-z%]*)$","i"), Wt = /queueHooks$/, B = [wt], S = {
        "*": [function(t, n) {
    ...
    ;function wt(t, n, i) {
        var o, f, m, p, l, g, u, v, d = this, h = {}, s = t.style, c = t.nodeType && D(t), a = e.e$(t, "fxshow");
        i.queue || (l = e.r$(t, "fx"),
        ...
        1 === t.nodeType && ("height"in n || "width"in n) && (i.overflow = [s.overflow, s.overflowX, s.overflowY],
        u = e.css(t, "display"),
        v = "none" === u ? e.e$(t, "olddisplay") || F(t.nodeName) : u,
        "inline" === v && "none" === e.css(t, "float") && (r.inlineBlockNeedsLayout && "inline" !== F(t.nodeName) ? s.zoom = 1 : s.display = "inline-block")),
        i.overflow && (s.overflow = "hidden",
        r.shrinkWrapBlocks() || d.always(function() {
        ...
        if (e.isEmptyObject(h))
            "inline" === ("none" === u ? F(t.nodeName) : u) && (s.display = u);
        else {
            a ? "hidden"in a && (c = a.hidden) : a = e.e$(t, "fxshow", {}),
            m && (a.hidden = !c),
            c ? e(t).show() : d.done(function() {
                e(t).hide()
            }),
            d.done(function() {
                var n;
    ...
    ;function Ye(t, n, r) {
        var u, a, s = 0, d = B.length, o = e.Deferred().always(function() {
            delete c.elem
        }), c = function() {
            if (a)
                return !1;
            for (var l = E || lt(), e = Math.max(0, i.startTime + i.duration - l), u = e / i.duration || 0, n = 1 - u, r = 0, s = i.tweens.length; s > r; r++)
                i.tweens[r].run(n);
            return o.notifyWith(t, [i, n, e]),
            1 > n && s ? e : (o.resolveWith(t, [i]),
            !1)
        }, i = o.promise({
            elem: t,
            props: e.extend({}, n),
            ...
            stop: function(e) {
                ...
                for (a = !0; r > n; n++)
                    i.tweens[n].run(1);
                return e ? o.resolveWith(t, [i, e]) : o.rejectWith(t, [i, e]),
                this
            }
        }), l = i.props;
        for (yt(l, i.opts.specialEasing); d > s; s++)
            if (u = B[s].call(i, t, l, i.opts))
                return u;
        return e.map(l, ut, i),
        e.isFunction(i.opts.start) && i.opts.start.call(t, i),
    ...
    e.speed = function(t, n, r) {
        ...
        return i.duration = e.fx.off ? 0 : "number" == typeof i.duration ? i.duration : i.duration in e.fx.speeds ? e.fx.speeds[i.duration] : e.fx.speeds.t$,
    ...
    e.fn.extend({
        ...
        stop: function(t, n, r) {
            ...
            this.each(function() {
                ...
                if (n)
                    ...
                    for (n in o)
                        o[n] && o[n].stop && Wt.test(n) && i(o[n]);
                for (n = a.length; n--; )
                    a[n].elem !== this || null != t && a[n].queue !== t || (a[n].anim.stop(r),
                    s = !1,
                    a.splice(n, 1));
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"),
            this.each(function() {
                var n, o = e.e$(this), r = o[t + "queue"], a = o[t + "queueHooks"], i = e.timers, s = r ? r.length : 0;
                for (o.finish = !0,
                e.queue(this, t, []),
    ...
    e.timers = [],
    e.fx.tick = function() {
        var r, t = e.timers, n = 0;
        for (E = e.now(); n < t.length; n++)
            r = t[n],
    ...
    function() {
        ...
        a = o.appendChild(i.createElement("option")),
        e = t.getElementsByTagName("input")[0],
        n.style.cssText = "top:1px",
        r.getSetAttribute = "t" !== t.className,
        r.style = /top/.test(n.getAttribute("style")),
        r.hrefNormalized = "/a" === n.getAttribute("href"),
        r.checkOn = !!e.value,
        r.optSelected = a.selected,
        r.enctype = !!i.createElement("form").enctype,
        o.disabled = !0,
        r.optDisabled = !a.disabled,
        e = i.createElement("input"),
        e.setAttribute("value", ""),
        r.input = "" === e.getAttribute("value"),
        e.value = "t",
        e.setAttribute("type", "radio"),
        r.radioValue = "t" === e.value
    }();
    var Tt = /\r/g;
    e.fn.extend({
        val: function(t) {
            var n, r, o, i = this[0];
            {
                if (arguments.length)
                    ...
                    this.each(function(r) {
                        var i;
                        1 === this.nodeType && (i = o ? t.call(this, r, e(this).val()) : t,
                        null == i ? i = "" : "number" == typeof i ? i += "" : e.isArray(i) && (i = e.map(i, function(e) {
                            return null == e ? "" : e + ""
                        })),
                        n = e.valHooks[this.type] || e.valHooks[this.nodeName.toLowerCase()],
                        n && "set"in n && void 0 !== n.set(this, i, "value") || (this.value = i))
                    });
                if (i)
                    return n = e.valHooks[i.type] || e.valHooks[i.nodeName.toLowerCase()],
                    n && "get"in n && void 0 !== (r = n.get(i, "value")) ? r : (r = i.value,
                    "string" == typeof r ? r.replace(Tt, "") : null == r ? "" : r)
            }
        }
    }),
    e.extend({
            ...
            select: {
                get: function(t) {
                    for (var s, n, l = t.options, i = t.selectedIndex, o = "select-one" === t.type || 0 > i, u = o ? null : [], c = o ? i + 1 : l.length, a = 0 > i ? c : o ? i : 0; c > a; a++)
                        if (n = l[a],
                        !(!n.selected && a !== i || (r.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && e.nodeName(n.parentNode, "optgroup"))) {
                            if (s = e(n).val(),
                            o)
                                return s;
                            u.push(s)
                ...
                set: function(t, n) {
                    var a, i, o = t.options, l = e.makeArray(n), s = o.length;
                    while (s--)
                        if (i = o[s],
                        e.inArray(e.valHooks.option.get(i), l) >= 0)
                            try {
                                i.selected = a = !0
                            } catch (r) {
                                i.scrollHeight
    ...
    var C, Re, f = e.expr.attrHandle, oe = /^(?:checked|selected)$/i, b = r.getSetAttribute, z = r.input;
    e.fn.extend({
        attr: function(t, n) {
    ...
    e.extend({
        attr: function(t, n, r) {
            ...
            if (t && 3 !== a && 8 !== a && 2 !== a)
                return typeof t.getAttribute === u ? e.prop(t, n, r) : (1 === a && e.isXMLDoc(t) || (n = n.toLowerCase(),
                i = e.attrHooks[n] || (e.expr.match.bool.test(n) ? Re : C)),
                void 0 === r ? i && "get"in i && null !== (o = i.get(t, n)) ? o : (o = e.find.attr(t, n),
                null == o ? void 0 : o) : null !== r ? i && "set"in i && void 0 !== (o = i.set(t, r, n)) ? o : (t.setAttribute(n, r + ""),
                r) : void e.removeAttr(t, n))
        },
        removeAttr: function(t, n) {
            ...
            if (o && 1 === t.nodeType)
                while (r = o[a++])
                    i = e.propFix[r] || r,
                    e.expr.match.bool.test(r) ? z && b || !oe.test(r) ? t[i] = !1 : t[e.camelCase("default-" + r)] = t[i] = !1 : e.attr(t, r, ""),
                    t.removeAttribute(b ? r : i)
        },
        attrHooks: {
            type: {
                set: function(t, n) {
    ...
    Re = {
        set: function(t, n, r) {
            return n === !1 ? e.removeAttr(t, r) : z && b || !oe.test(r) ? t.setAttribute(!b && e.propFix[r] || r, r) : t[e.camelCase("default-" + r)] = t[r] = !0,
            r
        }
    },
    ...
    e.extend({
        ...
        prop: function(t, n, r) {
            ...
            if (t && 3 !== a && 8 !== a && 2 !== a)
                return s = 1 !== a || !e.isXMLDoc(t),
                s && (n = e.propFix[n] || n,
                i = e.propHooks[n]),
                void 0 !== r ? i && "set"in i && void 0 !== (o = i.set(t, r, n)) ? o : t[n] = r : i && "get"in i && null !== (o = i.get(t, n)) ? o : t[n]
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
    ...
    e.fn.extend({
        addClass: function(t) {
            var s, n, r, i, l, o, a = 0, u = this.length, d = "string" == typeof t && t;
            if (e.isFunction(t))
            ...
            if (d)
                for (s = (t || "").match(c) || []; u > a; a++)
                    if (n = this[a],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Q, " ") : " ")) {
                        l = 0;
                        while (i = s[l++])
                            r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                        o = e.trim(r),
        ...
        removeClass: function(t) {
            var s, n, r, i, l, o, a = 0, u = this.length, d = 0 === arguments.length || "string" == typeof t && t;
            if (e.isFunction(t))
                return this.each(function(n) {
        ...
        toggleClass: function(t, n) {
            ...
            : function() {
                if ("string" === r) {
                    var n, o = 0, i = e(this), a = t.match(c) || [];
                    while (n = a[o++])
                        i.hasClass(n) ? i.removeClass(n) : i.addClass(n)
                } else
                    (r === u || "boolean" === r) && (this.className && e.e$(this, "__className__", this.className),
                    this.className = this.className || t === !1 ? "" : e.e$(this, "__className__") || "")
            }
            )
        },
        hasClass: function(e) {
            for (var n = " " + e + " ", t = 0, r = this.length; r > t; t++)
                if (1 === this[t].nodeType && (" " + this[t].className + " ").replace(Q, " ").indexOf(n) >= 0)
                    return !0;
            return !1
        }
    }),
    ...
    e.parseXML = function(n) {
        ...
        ;return i && i.documentElement && !i.getElementsByTagName("parsererror").length || e.error("Invalid XML: " + n),
        i
    }
    ;
    var x, d, en = /#.*$/, Ee = /([?&])_=[^&]*/, tn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, rn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, on = /^(?:GET|HEAD)$/, ln = /^\/\//, pe = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, de = {}, te = {}, Oe = "*/".concat("*");
    try {
        d = location.href
    } catch (o) {
        d = i.createElement("a"),
    ...
    function Ue(t) {
        return function(n, r) {
            "string" != typeof n && (r = n,
            n = "*");
            var i, o = 0, a = n.toLowerCase().match(c) || [];
            if (e.isFunction(r))
                while (i = a[o++])
                    "+" === i.charAt(0) ? (i = i.slice(1) || "*",
                    (t[i] = t[i] || []).unshift(r)) : (t[i] = t[i] || []).push(r)
        }
    }
    ;function Ve(t, n, r, i) {
        var o = {}
    ...
    ;function mt(e, t, n) {
        ...
        ;return i ? (i !== r[0] && r.unshift(i),
        n[i]) : void 0
    }
    ;function vt(e, t, n, r) {
        var c, o, a, u, s, l = {}, d = e.dataTypes.slice();
        if (d[1])
    ...
    ;e.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var f, u, a, y, b, p, h, g, r = e.ajaxSetup({}, n), l = r.context || r, T = r.context && (l.nodeType || l.jquery) ? e(l) : e.event, w = e.Deferred(), k = e.Callbacks("once memory"), m = r.statusCode || {}, C = {}, N = {}, s = 0, E = "canceled", i = {
                readyState: 0,
            ...
            if (w.promise(i).complete = k.add,
            i.success = i.done,
            i.error = i.fail,
            r.url = ((t || r.url || d) + "").replace(en, "").replace(ln, x[1] + "//"),
            r.type = n.method || n.type || r.method || r.type,
            r.dataTypes = e.trim(r.dataType || "*").toLowerCase().match(c) || [""],
            null == r.crossDomain && (f = pe.exec(r.url.toLowerCase()),
            r.crossDomain = !(!f || f[1] === x[1] && f[2] === x[2] && (f[3] || ("http:" === f[1] ? "80" : "443")) === (x[3] || ("http:" === x[1] ? "80" : "443")))),
            ...
            r.hasContent = !on.test(r.type),
            a = r.url,
            r.hasContent || (r.data && (a = r.url += (G.test(a) ? "&" : "?") + r.data,
            delete r.data),
            r.cache === !1 && (r.url = Ee.test(a) ? a.replace(Ee, "$1_=" + X++) : a + (G.test(a) ? "&" : "?") + "_=" + X++)),
            r.ifModified && (e.lastModified[a] && i.setRequestHeader("If-Modified-Since", e.lastModified[a]),
            e.etag[a] && i.setRequestHeader("If-None-Match", e.etag[a])),
            (r.data && r.hasContent && r.contentType !== !1 || n.contentType) && i.setRequestHeader("Content-Type", r.contentType),
            ...
            if (r.beforeSend && (r.beforeSend.call(l, i, r) === !1 || 2 === s))
                return i.abort();
            E = "abort";
            for (u in {
                success: 1,
            ...
            function v(t, n, o, u) {
                ...
                o && (f = mt(r, i, o)),
                f = vt(r, f, i, d),
                d ? (r.ifModified && (g = i.getResponseHeader("Last-Modified"),
                g && (e.lastModified[a] = g),
                g = i.getResponseHeader("etag"),
                g && (e.etag[a] = g)),
                204 === t || "HEAD" === r.type ? c = "nocontent" : 304 === t ? c = "notmodified" : (c = f.state,
                x = f.data,
                v = f.error,
                d = !v)) : (v = c,
                (t || !c) && (c = "error",
                ...
                i.status = t,
                i.statusText = (n || c) + "",
                d ? w.resolveWith(l, [x, c, i]) : w.rejectWith(l, [i, c, v]),
                i.statusCode(m),
                m = void 0,
                p && T.trigger(d ? "ajaxSuccess" : "ajaxError", [i, r, d ? x : v]),
                k.fireWith(l, [i, c]),
                p && (T.trigger("ajaxComplete", [i, r]),
    ...
    r.cors = !!L && "withCredentials"in L,
    L = r.ajax = !!L,
    L && e.ajaxTransport(function(t) {
        if (!t.crossDomain || r.cors) {
            ...
            return {
                send: function(r, i) {
                    ...
                    for (a in r)
                        void 0 !== r[a] && o.setRequestHeader(a, r[a] + "");
    ...
    e.ajaxPrefilter("json jsonp", function(n, r, i) {
        ...
        l ? n[l] = n[l].replace(Y, "$1" + o) : n.jsonp !== !1 && (n.url += (G.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
    ...
    e.parseHTML = function(t, n, r) {
        ...
        var o = be.exec(t)
          , a = !r && [];
        return o ? [n.createElement(o[1])] : (o = e.buildFragment([t], n, a),
    ...
    e.fn.load = function(t, n, r) {
        ...
        var i, s, l, o = this, a = t.indexOf(" ");
        return a >= 0 && (i = e.trim(t.slice(a, t.length)),
        t = t.slice(0, a)),
        e.isFunction(n) ? (r = n,
    ...
    ;e.offset = {
        setOffset: function(t, n, r) {
            var a, s, l, u, i, c, p, d = e.css(t, "position"), f = e(t), o = {};
            "static" === d && (t.style.position = "relative"),
            i = f.offset(),
            l = e.css(t, "top"),
            c = e.css(t, "left"),
            p = ("absolute" === d || "fixed" === d) && e.inArray("auto", [l, c]) > -1,
            p ? (a = f.position(),
            u = a.top,
            s = a.left) : (u = parseFloat(l) || 0,
            s = parseFloat(c) || 0),
            e.isFunction(n) && (n = n.call(t, r, i)),
            null != n.top && (o.top = n.top - i.top + u),
            null != n.left && (o.left = n.left - i.left + s),
            "using"in n ? n.using.call(t, o) : f.css(o)
        }
    },
    e.fn.extend({
        offset: function(t) {
            ...
            if (a)
                ...
                e.contains(n, r) ? (typeof r.getBoundingClientRect !== u && (i = r.getBoundingClientRect()),
                o = Be(a),
                {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === e.css(i, "position") ? r = i.getBoundingClientRect() : (t = this.offsetParent(),
                r = this.offset(),
                e.nodeName(t[0], "html") || (n = t.offset()),
    ...
    e.each(["top", "left"], function(t, n) {
        e.cssHooks[n] = ce(r.pixelPosition, function(t, r) {
            return r ? (r = v(t, n),
            M.test(r) ? e(t).position()[n] + "px" : r) : void 0
        })
    }),
    e.each({
        Height: "height",
        ...
        e.each({
            ...
            e.fn[i] = function(i, o) {
                ...
                return y(this, function(n, r, i) {
                    ...
                    Math.max(n.body["scroll" + t], o["scroll" + t], n.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === i ? e.css(n, r, s) : e.style(n, r, i, s)
                }, n, a ? i : void 0, a, null)
            }
        })
    }),
...
function() {
    ...
    function e(t, n) {
        ...
        !e.notNeeded(t)) {
            for (var i = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = this, c = 0, l = i.length; l > c; c++)
                r[i[c]] = a(r[i[c]], r);
            ...
            Event.prototype.stopImmediatePropagation || (t.removeEventListener = function(e, o, n) {
    ...
    e.prototype.sendClick = function(e, t) {
        ...
        o.initMouseEvent(this.determineEventType(e), !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null),
    ...
    e.prototype.onTouchEnd = function(e) {
        ...
        "label" === r) {
            ...
            return e.timeStamp - i > 100 || n && window.top !== window && "input" === r ? (this.targetElement = null,
            !1) : (this.focus(d),
            this.sendClick(d, e),
            n && "select" === r || (this.targetElement = null,
            e.preventDefault()),
            !1);
        return n && !a && (c = d.fastClickScrollParent,
        c && c.fastClickLastScrollTop !== c.scrollTop) ? !0 : (this.needsClick(d) || (e.preventDefault(),
        this.sendClick(d, e)),
        !1)
    }
    ,
    ...
    e.notNeeded = function(e) {
        ...
        if (i && (a = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
        ...
        return "none" === e.style.msTouchAction || "manipulation" === e.style.touchAction ? !0 : (s = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1],
        s >= 27 && (t = document.querySelector("meta[name=viewport]"),
...
$(document).ready(function() {
    function e() {
        ...
        $.ajax({
            ...
            success: function(e) {
                if ("" != e) {
                    0 == t && $("#comments #no-comments").remove(),
                    $("#comments #load-comments").before(e),
                    "createTouch"in document || $(".comments-scroll").perfectScrollbar("update"),
    ...
    "createTouch"in document) {
        var t = jQuery("body");
        t.removeClass("non-touch"),
        $("table").removeClass("table-hover")
    }
    $(".notice-flash").length > 0 && $(".notice-flash").delay(2300).slideUp(),
    $("noscript").length > 0 && $("noscript").remove(),
    void 0 === $.cookie("yts_lang") && $.ajax({}),
    ...
    $("#quick-search-input").focus(function() {
        o == $("#quick-search-input").val() ? $("#quick-search-input").val("") : $("#quick-search-input").val().length > 2 && $(".ac-results ul").not(":empty") && $(".ac-results").slideDown(),
        $(".ac-results").css({
            left: $("#quick-search").position().left
        })
    }),
    ...
    $("#quick-search-input").keyup(function(e) {
        ...
        if (t === o.enter || t === o.esc || t === o.up || t === o.down || t === o.left || t === o.right)
            return !1;
        ...
        if ($(".ac-results").is(":visible")) {
            ...
            if (!$(".ac-results li").hasClass("ac-no-results")) {
                ...
                case o.up:
                    if (a) {
                        if (s) {
                            $("li.ac-item-selected", n).removeClass("ac-item-selected"),
                            $("ul li", n).last().addClass("ac-item-selected");
                            break
                        }
                        $("li.ac-item-selected", n).prev().addClass("ac-item-selected"),
                        $("li.ac-item-selected", n).next().removeClass("ac-item-selected")
                    } else
                        $("ul li", n).last().addClass("ac-item-selected");
                    break;
                case o.down:
                    if (a) {
                        if (i) {
                            $("li.ac-item-selected", n).removeClass("ac-item-selected"),
                            $("ul li", n).first().addClass("ac-item-selected");
                            break
                        }
                        $("li.ac-item-selected", n).next().addClass("ac-item-selected"),
                        $("li.ac-item-selected", n).prev().removeClass("ac-item-selected")
                    } else
                        $("ul li", n).first().addClass("ac-item-selected");
                    break;
                case o.enter:
    ...
    $("#index-search-input").focus(function() {
        io == $("#index-search-input").val() ? $("#index-search-input").val("") : $("#index-search-input").val().length > 2 && $(".index-ac-results ul").not(":empty") && $(".index-ac-results").slideDown(),
        $(".index-ac-results").css({})
    }),
    ...
    $("#index-search-input").keyup(function(e) {
        ...
        if (t === io.enter || t === io.esc || t === io.up || t === io.down || t === io.left || t === io.right)
            return !1;
        ...
        a.length >= 3 && n(function() {
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    $(".index-ac-results ul").html(t),
                    $(".index-ac-results").is(":visible") || $(".index-ac-results").slideDown(),
                    $(".index-ac-results ul li:first-child").addClass("ac-item-hover"),
                    $(".index-ac-results ul li:first-child").addClass("ac-item-selected"),
                    $(".ajax-spinner").fadeOut("fast")
                },
                error: function(e) {
                    var t = "";
                    t = '<li class="ac-no-results">Error: ' + e.statusText + " (Code " + e.status + ")</li>",
                    $(".index-ac-results ul").html(t),
                    $(".index-ac-results").not(":visible") && $(".index-ac-results").slideDown(),
                    $(".index-ac-results ul li:first-child").addClass("ac-item-selected"),
                    $(".ajax-spinner").fadeOut("fast")
                }
            })
    ...
    $(document).keydown(function(e) {
        if ($(".index-ac-results").is(":visible")) {
            ...
            if (t === io.esc)
                return $(".index-ac-results").slideUp(),
                !1;
    ...
    $(".parental-guide-modal").click(function() {
        ...
        $(".modal-parental-guide .modal-content .modal-loading-content").length < 1 || $.ajax({
            ...
            success: function(e) {
                ...
                e.data.parental_guide_count > 0 ? $.each(e.data.parental_guides, function(e, t) {
            ...
            error: function(e) {
                ...
                0 == e.status && (e.statusText = "Page did not respond"),
    ...
    $("#modal-login").click(function() {
        $(".modal-auth").hasClass("modal-busy") || ($(this).addClass("selected").siblings().removeClass("selected"),
        $(".modal-login-content").show().siblings().hide())
    }),
    ...
    $(".modal-login-content button").click(function() {
        ...
        $.ajax({
            ...
            type: "POST",
            success: function(e) {
                "ok" == e.status ? window.location.reload() : ($(".modal-auth").removeClass("modal-busy"),
    ...
    $(".modal-register-content button").click(function() {
        ...
        $.ajax({
            ...
            type: "POST",
            success: function(e) {
                "ok" == e.status ? ($(location).attr('href', '/'),
                $(".modal-auth").removeClass("modal-busy"),
                $(".modal-register-content input[name='username']").val(""),
                $(".modal-register-content input[name='email']").val(""),
                $(".modal-register-content input[name='password']").val(""),
                $(".modal-register-content input[name='password_confirmation']").val(""),
                $(".modal-activate-account-content").show().siblings().hide()) : ($(".modal-auth").removeClass("modal-busy"),
                $(".modal-register-content input[name='password']").val(""),
                $(".modal-register-content input[name='password_confirmation']").val(""),
                $(".modal-register-content .error-msg").text("Error: " + e.message),
                $(".modal-register-content").show().siblings().hide())
            },
            error: function(e) {
                $(".modal-auth").removeClass("modal-busy"),
    ...
    "createTouch"in document || ($("#comments").addClass("comments-scroll"),
    $(".comments-scroll").perfectScrollbar({
        wheelPropagation: !0
    })),
    $("#movie-comments").length && e(),
    ...
    $("#comments-box input").click(function() {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(t) {
                "error" == t.status ? ($("#comments-box .error-msg").text(t.message),
                $("#comments-box input").show(),
                $("#comments-box textarea").show(),
                $("#comments-box .ajax-spinner").hide()) : ($("#comments-box").text(t.message),
    ...
    $(".rss-generate").click(function() {
        var e = $('[name="rss_keyword"]').val()
          ...
          , a = rssBaseUrl + "/";
        a += e.trim().length < 1 ? "0/" : encodeURIComponent(e) + "/",
        a += t + "/" + o + "/" + n + "/" + l,
        $('[name="generated_link"]').val(a),
        $(".generated-rss").fadeIn()
    }),
    $(".bookmark").on("click", function() {
        var e = $("#movie-info").data("movie-id");
        $(".bookmark").attr("class").indexOf("bookmarked") < 0 ? ($(this).addClass("bookmarked"),
        $.ajax({
            type: "POST",
    ...
    $(".delete-bookmark").click(function() {
        ...
        $(this).closest(".browse-movie-wrap").fadeTo(400, .1),
        $.ajax({
            type: "POST",
            url: "/ajax/bookmark/delete/" + e,
            dataType: "json"
...
(function(t, a, x) {
    ...
    }, g = 'colorbox', s = 'cbox', W = s + 'Element', ue = s + '_open', D = s + '_load', N = s + '_complete', re = s + '_cleanup', oe = s + '_closed', j = s + '_purge', v, i, k, u, ne, ie, te, ee, f, C, l, R, O, G, se, E, M, I, K, q, w = t('<a/>'), e, m, p, T, b, c, n, y, L, S, he, h, r = 'div', z = 0, ce = {}, Q;
    function o(e, i, n) {
    ...
    ;var pe = (function() {
        var r, t = s + 'Slideshow_', o = 'click.' + s, d;
        function n() {
            clearTimeout(d)
        }
        ;function a() {
            ...
            if (o > 1) {
                ...
                if (e.get('preloading')) {
                    t.each([F(-1), F(1)], function() {
                        var n, o = f[this], i = new A(o,t.data(o, g)), e = i.get('href');
                        if (e && le(i, e)) {
                            e = de(i, e);
...
(function(e) {
    ...
    e.fn.perfectScrollbar = function(n, i) {
        return this.each(function() {
            ...
            ;function B(e) {
                return s.minScrollbarLength && (e = Math.max(e, s.minScrollbarLength)),
                s.maxScrollbarLength && (e = Math.min(e, s.maxScrollbarLength)),
                e
            }
            ;function le() {
                var e = {
                ...
                e.left = Y ? a.scrollLeft() + f - v : a.scrollLeft(),
                W ? e.bottom = D - a.scrollTop() : e.top = A + a.scrollTop(),
                d.css(e);
                var t = {
                    top: a.scrollTop(),
                    height: x
                };
                k ? t.right = Y ? v - a.scrollLeft() - C - T.outerWidth() : C - a.scrollLeft() : t.left = Y ? a.scrollLeft() + 2 * f - v - X - T.outerWidth() : X + a.scrollLeft(),
                u.css(t),
                E.css({
                    left: m,
                    width: b - ce
            ...
            ;function y() {
                ...
                f = s.includePadding ? a.innerWidth() : a.width(),
                p = s.includePadding ? a.innerHeight() : a.height(),
                v = a.prop("scrollWidth"),
                w = a.prop("scrollHeight"),
                !s.suppressScrollX && v > f + s.scrollXMarginOffset ? (P = !0,
                M = f - te,
                b = B(t(M * f / v)),
                m = t(a.scrollLeft() * (M - b) / (v - f))) : (P = !1,
                b = 0,
                m = 0,
                a.scrollLeft(0)),
                !s.suppressScrollY && w > p + s.scrollYMarginOffset ? (S = !0,
                x = p - se,
                g = B(t(x * p / w)),
                L = t(a.scrollTop() * (x - g) / (w - p))) : (S = !1,
                g = 0,
                L = 0,
                a.scrollTop(0)),
                m >= M - b && (m = M - b),
            ...
            ;function ne() {
                var t, o, n = function(e) {
                    ...
                    d.removeClass("in-scrolling"),
                    e(h).unbind(c("mousemove"), n)
                };
                E.bind(c("mousedown"), function(l) {
                    o = l.pageX,
                    t = E.position().left,
                    d.addClass("in-scrolling"),
                    e(h).bind(c("mousemove"), n),
                    e(h).one(c("mouseup"), r),
                    l.stopPropagation(),
                    l.preventDefault()
                }),
            ...
            ;function I(e, t) {
                ...
                if (0 === e) {
                    if (!S)
                        return !1;
                    if (0 === n && t > 0 || n >= w - p && 0 > t)
                        return !s.wheelPropagation
                }
                ;var o = a.scrollLeft();
                if (0 === t) {
                    if (!P)
                        return !1;
                    if (0 === o && 0 > e || o >= v - f && e > 0)
                        return !s.wheelPropagation
                }
                ;return !0
            }
            ;function ee(e, t) {
                var o = a.scrollTop()
                  ...
                  , l = Math.abs(t);
                if (l > r) {
                    if (0 > t && o === w - p || t > 0 && 0 === o)
                        return !s.swipePropagation
                } else if (r > l && (0 > e && n === v - f || e > 0 && 0 === n))
                    return !s.swipePropagation;
                return !0
            }
            ;function Q() {
                ...
                ;function t(t) {
                    if (l || !(a.find("select:focus").length > 0)) {
                        var i = o(t)
                          ...
                          , r = i[1];
                        e = !1,
                        s.useBothWheelAxes ? S && !P ? (r ? a.scrollTop(a.scrollTop() - r * s.wheelSpeed) : a.scrollTop(a.scrollTop() + n * s.wheelSpeed),
                        e = !0) : P && !S && (n ? a.scrollLeft(a.scrollLeft() + n * s.wheelSpeed) : a.scrollLeft(a.scrollLeft() - r * s.wheelSpeed),
                        e = !0) : (a.scrollTop(a.scrollTop() - r * s.wheelSpeed),
                        a.scrollLeft(a.scrollLeft() + n * s.wheelSpeed)),
                        y(),
                        e = e || I(n, r),
                        e && (t.stopPropagation(),
                        t.preventDefault())
            ...
            ;function N() {
                ...
                e(h).bind(c("keydown"), function(n) {
                    if ((!n.isDefaultPrevented || !n.isDefaultPrevented()) && t) {
                        for (var i = document.activeElement ? document.activeElement : h.activeElement; i.shadowRoot; )
                        ...
                        if (!e(i).is(":input,[contenteditable]")) {
                            ...
                            ;a.scrollTop(a.scrollTop() - r),
                            a.scrollLeft(a.scrollLeft() + l),
                            o = I(l, r),
                            o && n.preventDefault()
                        }
                    }
            ...
            ;function U() {
                ...
                ;function i() {
                    o || (o = setInterval(function() {
                        return O() ? (a.scrollTop(a.scrollTop() + t.top),
                        a.scrollLeft(a.scrollLeft() + t.left),
                        y(),
                        void 0) : (clearInterval(o),
                        void 0)
                    }, 50))
                }
                ;function r() {
                ...
                e(window).bind(c("mousemove"), function(e) {
                    if (n) {
                        ...
                        o.x < l.left + 3 ? (t.left = -5,
                        d.addClass("in-scrolling")) : o.x > l.right - 3 ? (t.left = 5,
                        d.addClass("in-scrolling")) : t.left = 0,
                        o.y < l.top + 3 ? (t.top = 5 > l.top + 3 - o.y ? -5 : -20,
                        u.addClass("in-scrolling")) : o.y > l.bottom - 3 ? (t.top = 5 > o.y - l.bottom + 3 ? 5 : 20,
                        u.addClass("in-scrolling")) : t.top = 0,
                        0 === t.top && 0 === t.left ? r() : i()
                    }
                })
            }
            ;function q(t, n) {
                ...
                ;function g() {
                    ...
                    r = setInterval(function() {
                        return O() ? .01 > Math.abs(o.x) && .01 > Math.abs(o.y) ? (clearInterval(r),
                        void 0) : (b(30 * o.x, 30 * o.y),
                        o.x *= .8,
                        o.y *= .8,
                ...
                ;var l = {}
                  ...
                  , i = !1
                  , s = !1;
                t && (e(window).bind(c("touchstart"), d),
                e(window).bind(c("touchend"), p),
                a.bind(c("touchstart"), f),
                a.bind(c("touchmove"), v),
                a.bind(c("touchend"), g)),
                n && (window.PointerEvent ? (e(window).bind(c("pointerdown"), d),
                e(window).bind(c("pointerup"), p),
                a.bind(c("pointerdown"), f),
                a.bind(c("pointermove"), v),
                a.bind(c("pointerup"), g)) : window.MSPointerEvent && (e(window).bind(c("MSPointerDown"), d),
                e(window).bind(c("MSPointerUp"), p),
                a.bind(c("MSPointerDown"), f),
                a.bind(c("MSPointerMove"), v),
                a.bind(c("MSPointerUp"), g)))
            }
            ;function K() {
            ...
            ;function H() {
                ...
                d.remove(),
                u.remove(),
                a = d = u = E = T = P = S = f = p = v = w = b = m = D = W = A = g = L = C = k = X = Y = c = null
            }
            ;function ue() {
                y(),
                K(),
                ...
                a.data("perfect-scrollbar-update", y),
                a.data("perfect-scrollbar-destroy", H)
            }
            ;var s = e.extend(!0, {}, o)
              , a = e(this)
              , O = function() {
...
(function(e) {
    e.fn.autogrow = function(i) {
        function n(s) {
            var n = e(this), h = n.innerHeight(), t = this.scrollHeight, a = n.data('autogrow-start-height') || 0, o;
            if (h < t) {
                this.scrollTop = 0;
